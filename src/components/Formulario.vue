        ...
        >
            <div class="mb-5">
                ...
                <input 
                    ...
                    class="border-2 border-stone-300 w-full p-2 mt-2 placeholder-gray-400 rounded-md"     
                    :value="nombre"
            ...
            <div class="mb-5">
                ...
                <textarea
                    ...
                    class="border-2 border-stone-300 w-full p-2 mt-2 placeholder-gray-400 rounded-md h-40"  
                    :value="sintomas"                    
